...
<form action="{{ route('search.results', ['locale' => app()->getLocale()]) }}" method="GET" id="searchForm"
    data-old-type="{{ old('type', 'keyword') }}" data-old-query="{{ old('query') }}">
        ...
        <div>
            ...
            <div class="form-check form-check-inline">
                ...
                <label class="form-check-label" for="category"
                    data-category-label="{{ __('index.category') }}:">{{ __('index.category') }}</label>
            </div>
            <div class="form-check form-check-inline">
